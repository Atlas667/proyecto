	...
	if($p == "login"){
		...
		if(!empty($list[$user]))
		{
		  	if($list[$user] == $pass){
		  		...
		  		header("refresh:3;url=http://sici4997.uprp.edu/~josue.nadal/proyecto/index.php");
		  		exit();
		  	}else{
			  	echo "Log in unsuccesful.";
			  	header("refresh:3;url=http://sici4997.uprp.edu/~josue.nadal/proyecto/index.php?p=Log in");
			  	exit();
		  	}
		}else
		{
